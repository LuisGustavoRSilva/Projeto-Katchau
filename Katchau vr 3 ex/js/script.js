        ...
        produtos.forEach((produto) => {
          saida += `
            <div class="computador">
              ...
              <h3>${produto.nome}</h3>
              <p class="livpreco">R$ ${produto.preco}</p>
              <a href="detalhes.html?id=${produto.id}">Mais detalhes</a>
            </div>
          `;
        });
